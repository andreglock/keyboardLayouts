...
This layout is intended to allow easy writting in Portuguese, Spanish, German, Dutch and many other latin based languages. This layout doesn't modify the behaviour of special characters such as ' " ` allowing for smooth programing. 
